...
export default function DynamicForm({
  ...
  const handleMoveField = (currentIndex: number, direction: "up" | "down") => {
    const updatedFields = [...getValues("fields")];
  ...
  return (
    <form
      ...
      className="flex flex-col items-center w-3/4 gap-10 p-5 border border-zinc-500"
    >
      <div className="flex flex-col items-center w-4/5 gap-3 p-5">
        <label
          htmlFor="description"
          className="flex flex-col items-center justify-center w-4/5 gap-3"
        >
          <textarea
        ...
        >
          <legend className="px-3 mx-5 w-fit">
            <label
              ...
              className="flex items-center justify-start w-full gap-3 text-xs"
            >
              Item Name:
              <input
                required
          ...
          <div className="flex justify-between w-full">
            <label
              ...
              className="flex flex-col items-start w-3/4 gap-3"
            >
              Type:
              <select
                ...
                className={`w-1/2 h-10 p-2 rounded bg-primary-secondary  ${errors?.fields?.[index]?.question_type ? "border border-red-500" : ""}`}
                onChange={(e) => {
                  const selectedType = e.target.value;

                  clearErrors(`fields.${index}.question_type`);
              ...
              >
                <option value="" disabled>
                  {errors?.fields?.[index]?.question_type?.message ||
            ...
            <div className="flex items-start justify-between w-1/4 gap-5 h-fit">
              ...
              >
                <ArrowUpwardRounded
                  titleAccess="Move Up"
                  className={`w-full h-full text-white hover:text-green-600 transition-colors duration-300`}
                />
              </button>
              <button
                type="button"
              ...
              >
                <CopyAllOutlined
                  ...
                  className={`w-full h-full text-white hover:text-blue-600 transition-colors duration-300`}
                />
              </button>
              <button
                type="button"
              ...
              >
                <Delete
                  ...
                  className={`w-full h-full text-white hover:text-red-600 transition-colors duration-300`}
                />
              </button>
            </div>
          </div>
      ...
      <button
        ...
        className="flex items-center gap-1 text-lg font-bold text-green-500 transition-colors ease-in-out group hover:underline w-fit"
      >
        <AddCircleOutlineOutlined className="transition-all ease-in-out origin-center group-hover:rotate-180 " />
        Add Fieldset
      </button>
      {/* Submit Button */}
      <button
        type="submit"
        className="px-6 py-3 font-bold text-white bg-blue-500 w-fit"
      >
        Submit
      </button>
    </form>
