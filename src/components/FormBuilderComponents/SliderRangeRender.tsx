...
export default function SliderRangeRender({
   ...
   return (
      <div className="flex flex-col gap-3">
         <label htmlFor={`fields.${index}.maximum`} className="flex flex-col items-start w-fit gap-3">
            Maximum:
            <input
         ...
         <label htmlFor={`fields.${index}.minimum`} className="flex flex-col items-start w-fit gap-3">
            Minimum:
            <input
               min={1}
